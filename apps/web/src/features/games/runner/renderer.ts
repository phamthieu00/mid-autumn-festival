...
import { PLAYER } from '@maf/shared/games/runner/constants'
import { groundY, playerX } from '@maf/shared/games/runner/engine'
import type { Obstacle, Pickup, RunnerState } from '@maf/shared/games/runner/types'
