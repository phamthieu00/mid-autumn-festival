import { APPROACH, HIT_LINE_RATIO, LANE_COLORS, WINDOW } from '@maf/shared/games/rhythm/constants'
import { noteY } from '@maf/shared/games/rhythm/engine'
import type { RhythmState } from '@maf/shared/games/rhythm/types'
